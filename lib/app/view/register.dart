...
import 'package:driver/app/controller/register_controller.dart';
      ...
      builder: (value) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text('Register Request'.tr, style: ThemeProvider.titleStyle),
            leading: IconButton(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(color: Colors.white, border: Border(bottom: BorderSide(color: ThemeProvider.greyColor.shade400, width: 2.0))),
                                        child: Column(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: [
                                            ...
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                                Text(value.gender, textAlign: TextAlign.start, style: const TextStyle(fontSize: 12, color: ThemeProvider.blackColor)),
                                    ...
                                    Container(
                                      ...
                                      decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(25)), color: Colors.white),
                                      child: ElevatedButton(
                                        onPressed: () => value.onSaveInfo(),
                                        style: ElevatedButton.styleFrom(foregroundColor: ThemeProvider.whiteColor, backgroundColor: ThemeProvider.appColor, elevation: 0),
                                        child: value.isLogin.value == true
                                            ? const CircularProgressIndicator(color: ThemeProvider.whiteColor)
                                            : Text('Continue'.tr, style: const TextStyle(fontFamily: 'regular', fontSize: 16)),
                                      ),
                                    ),
                                  ],
                                ),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: value.driverCover == ''
                                          ? Container(
                                              width: double.infinity,
                                              height: 150,
                                              decoration: BoxDecoration(border: Border.all(color: ThemeProvider.greyColor), borderRadius: BorderRadius.circular(5)),
                                              child: Center(child: Text('Your your cover image'.tr, style: ThemeProvider.titleStyle)),
                                            )
                                          : SizedBox(
                                              width: double.infinity,
                                              height: 150,
                                              child: FadeInImage(
                                                image: NetworkImage('${Environments.apiBaseURL}storage/images/${value.driverCover}'),
                                    ...
                                    Container(
                                      ...
                                      decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: Color.fromRGBO(255, 255, 255, 1)),
                                      child: TextField(
                                        controller: value.driverAddress,
