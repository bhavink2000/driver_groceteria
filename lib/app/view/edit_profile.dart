                                      ...
                                      showCupertinoModalPopup<void>(
                                        ...
                                        builder: (BuildContext context) => CupertinoActionSheet(
                                          ...
                                          actions: <CupertinoActionSheetAction>[
                                            ...
                                            CupertinoActionSheetAction(
                                                child: Text('Cancel'.tr, style: const TextStyle(fontFamily: 'bold', color: Colors.red)), onPressed: () => Navigator.pop(context)),
                                          ],
                                        ),
                                      );
                                    },
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text('Available'.tr, textAlign: TextAlign.start, style: const TextStyle(fontSize: 12, color: ThemeProvider.blackColor)),
                                Switch(
                                  onChanged: (bool status) => value.updateStatus(status),
                                  value: value.current,
