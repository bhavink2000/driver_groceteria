...
import 'package:driver/app/controller/intro_controller.dart';
        ...
        Column(
          ...
          children: [
            Padding(
              ...
              child: Text('Fresh fruits and Vegetables'.tr, textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'bold', color: Colors.white, fontSize: 20)),
            ),
            Text(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 5),
              child: Text('Best quality grocery'.tr, style: const TextStyle(fontFamily: 'bold', color: Colors.white, fontSize: 20)),
            ),
            Text(
