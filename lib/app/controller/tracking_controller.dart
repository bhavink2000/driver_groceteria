...
class TrackingController extends GetxController implements GetxService {
  ...
  PinInformation sourcePinInfo = PinInformation(
      locationName: "Start Location", location: const LatLng(21.530435, 71.825037), pinPath: "assets/images/bike.png", avatarPath: "assets/images/bike.png", labelColor: Colors.blueAccent);
  PinInformation destinationPinInfo =
      PinInformation(locationName: "End Location", location: const LatLng(21.536411, 71.834638), pinPath: "assets/images/dest.png", avatarPath: "assets/images/dest.png", labelColor: Colors.purple);
  ...
  void setPolylines() async {
    ...
    if (result.points.isNotEmpty) {
      ...
      polylines.add(Polyline(width: 10, polylineId: const PolylineId("poly"), color: Colors.red, points: polylineCoordinates));
